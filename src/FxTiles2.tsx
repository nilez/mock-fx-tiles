...
export default function FxTiles2() {
    ...
    // const initialTiles = useTileMap<TileData>(tempTiles, (tile) => `${tile.currencyPair}-${tile.tenor}`);
    
    const { tiles, updateTile, updateServerTickRate } = useFxTilesState(tempTiles);

    // const collectStats = useCollectTileStats(initialStats);
